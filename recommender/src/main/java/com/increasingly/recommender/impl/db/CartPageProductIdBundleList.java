...
public class CartPageProductIdBundleList extends StoredProcedure implements ServiceInterface<Map<String,ArrayList<Map<String, Object>>>>
{
	private final static String dataSourceLookupName = "mysqlserver";
	private static final String SPROC_NAME = "Get_Cart_Page_Product_ID_BundleList";
	private static CartPageProductIdBundleList instance = null;
	
	private CartPageProductIdBundleList()
	{
	...
	public static CartPageProductIdBundleList getInstance()
	{
		if (instance == null)
		{
			instance = new CartPageProductIdBundleList();
		}
		return instance;
	}
