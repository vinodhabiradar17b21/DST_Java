...
public class DisabledRandomRotationProductIdList extends StoredProcedure implements ServiceInterface<ArrayList<Long>>{

	private final static String dataSourceLookupName = "mysqlserver";
	private static final String SPROC_NAME = "Get_Product_List_For_Random_Rotation_Freezing";
	private static DisabledRandomRotationProductIdList instance = null;
	
	private DisabledRandomRotationProductIdList()
	{
	...
	public static DisabledRandomRotationProductIdList getInstance()
	{
		if (instance == null)
		{
			instance = new DisabledRandomRotationProductIdList();
		}
		return instance;
	}
	...
	{		
		...
		ArrayList<Long> internalProductIdList = (ArrayList<Long>) execute(configId).get("#result-set-1");
