...
public class ProductDetailsResponseContent
{
	...
	public ProductDetailsResponseContent(ProductDetails productDetails)
	{
		this.productId = productDetails.getProductId();
		this.productName = productDetails.getProductName();
		this.productSku = productDetails.getProductSku();
		this.imageUrl = productDetails.getImageUrl();
		this.productUrl = productDetails.getProductUrl();
		this.price = productDetails.getPrice();
		this.specialPrice = productDetails.getSpecialPrice();
		this.description = productDetails.getDescription();
		this.quantity = productDetails.getQuantity();
		this.manufacturer = productDetails.getManufacturer();
		this.otherImageList = productDetails.getOtherImageList();
		...
		this.shortDescription = productDetails.getShortDescription();
		this.field1 = productDetails.getField1();
		this.field2 = productDetails.getField2();
		this.field3 = productDetails.getField3();
		this.field4 = productDetails.getField4();
		this.field5 = productDetails.getField5();
		this.field6 = productDetails.getField6();
		this.productAttributeDeatilsList = productDetails.getProductAttributeDeatilsList();
		this.categoryId = productDetails.getCategoryId();
	}
